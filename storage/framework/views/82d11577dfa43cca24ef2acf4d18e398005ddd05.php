    ...
    <div class="container-fluid">
        <div class="fade-in">
            ...
            <?php if(auth()->check() && auth()->user()->hasRole('viewer')): ?>
                <?php echo $__env->make('dashboard.viewerblocks', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sarai\resources\views/dashboard/homepage.blade.php ENDPATH**/ ?>